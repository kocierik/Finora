    ...
    t: (key: string, params?: Record<string, any>) => {
      const i18n: Record<LanguageCode, Record<string, string>> = {
        it: {
          ...
          ,confirm_subtitle: 'Tocca il pulsante per aprire le impostazioni e concedere i permessi per leggere le notifiche.'
          ,open_settings: 'Apri le impostazioni'
          ,next: 'Avanti'
          ,back: 'Indietro'
          ,recent_notifications: 'Notifiche recenti'
          ,no_notifications_yet: 'Nessuna notifica rilevata ancora'
        ...
        en: {
          ...
          ,confirm_title: 'Ready?'
          ,confirm_subtitle: 'Tap the button to open settings and grant read notification permissions.'
